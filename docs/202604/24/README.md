...
- 生成时间：2026-04-24 20:28:17 UTC
- 当次推荐总数：15
- 精读区：4
- 速读区：11

## 今日简报（AI）
今天重点梳理了15篇网络安全与系统智能方向论文，其中4篇精读聚焦核心方法突破。  
最值得关注的是图结构预测驱动的流量建模，以及面向代码与二进制的漏洞检索增强分析框架。  
建议优先跟进“图神经网络\+预测建模”和“漏洞自动化分析”两条路线的工程化落地进展。

## 精读区
1. [基于预测掩码图自编码器的个体NetFlow预测](/202604/24/2604.20483v1-forecasting-individual-netflows-using-a-predictive-masked-graph-autoencoder)（8.5/10）
...
2. [RAVEN：一种用于用户代码和二进制程序内存损坏分析的检索增强漏洞探索网络](/202604/24/2604.17948v1-raven-retrieval-augmented-vulnerability-exploration-network-for-memory-corruption-analysis-in-user-code-and-binary-programs)（8.4/10）
...
3. [网络防御基准：针对SecOps中LLM的主动威胁狩猎评估](/202604/24/2604.19533v1-cyber-defense-benchmark-agentic-threat-hunting-evaluation-for-llms-in-secops)（8.1/10）
...
4. [网络防御基准：用于安全运维中大语言模型主动威胁狩猎评估](/202604/24/2604.19533v2-cyber-defense-benchmark-agentic-threat-hunting-evaluation-for-llms-in-secops)（8.0/10）
...
## 速读区
1. [Cyber Defense Benchmark：面向SecOps中LLM的智能体威胁狩猎评估](/202604/24/2604.19533v3-cyber-defense-benchmark-agentic-threat-hunting-evaluation-for-llms-in-secops)（7.9/10）
...
2. [SecureRouter：用于高效安全推理的加密路由](/202604/24/2604.15499v1-securerouter-encrypted-routing-for-efficient-secure-inference)（7.8/10）
...
3. [DEMUX：面向多标签页网站指纹识别的边界感知多尺度流量解混](/202604/24/2604.15677v1-demux-boundary-aware-multi-scale-traffic-demixing-for-multi-tab-website-fingerprinting)（7.8/10）
...
4. [FedLLM：一种隐私保护的联邦大型语言模型，用于可解释的交通流预测](/202604/24/2604.16612v1-fedllm-a-privacy-preserving-federated-large-language-model-for-explainable-traffic-flow-prediction)（7.8/10）
...
5. [面向进攻性网络安全任务的前沿大语言模型系统性能力基准评测](/202604/24/2604.17159v1-systematic-capability-benchmarking-of-frontier-large-language-models-for-offensive-cyber-tasks)（7.8/10）
...
6. [ExAI5G：一种用于5G网络入侵检测的基于逻辑的可解释人工智能框架](/202604/24/2604.18052v1-exai5g-a-logic-based-explainable-ai-framework-for-intrusion-detection-in-5g-networks)（7.8/10）
...
7. [超越节点与边：一种基于溯源的多视角融合入侵检测框架](/202604/24/2604.14685v1-beyond-nodes-vs-edges-a-multi-view-fusion-framework-for-provenance-based-intrusion-detection)（6.8/10）
...
8. [加密控制系统中密码学参数与时延感知反馈增益的协同设计](/202604/24/2604.14774v1-co-design-of-cryptographic-parameters-and-delay-aware-feedback-gain-for-encrypted-control-systems)（6.8/10）
...
9. [高性能计算（HPC）互连网络中真实通信模式与拥塞动态的表征](/202604/24/2604.16088v1-characterization-of-real-communication-patterns-and-congestion-dynamics-in-hpc-interconnection-networks)（6.8/10）
...
10. [利用过程挖掘增强基于异常的入侵检测系统](/202604/24/2604.18066v1-enhancing-anomaly-based-intrusion-detection-systems-with-process-mining)（6.8/10）
...
11. [面向指令遵循信息检索的双视角训练](/202604/24/2604.18845v1-dual-view-training-for-instruction-following-information-retrieval)（6.8/10）
